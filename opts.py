...
def parse_opts():
    ...
    parser.add_argument('--lr_steps', default=[15, 25, 35, 45, 60, 150, 200, 250], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10') # [15, 30, 37, 50, 200, 250]
